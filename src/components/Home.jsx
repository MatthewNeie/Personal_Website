              ...
              <div className="home-body-left">
                ...
                <Reveal>
                  <p className="home-description">
                    I am a web developer and recently completed an accelerated
                    program for web development. I am interested in developing
                    my skills and adding projects to my portfolio by taking on
                    freelance projects or working on projects with other
                    developers. I am interested in full time or part time
                    employment opportunities, as well as internships or
                    apprenticeships. Feel free to contact me by completing my
                    contact form below.{" "}
                  </p>
                </Reveal>
                <br></br>
